...
import com.prorigo.thrillio.constants.Gender;
import com.prorigo.thrillio.constants.MovieGenre;
import com.prorigo.thrillio.constants.UserType;
...
public class DataStore {
	...
	private static void loadMovies() {
		...
		bookmarks[1][3] = BookmarkManager.getInstance().createMovie(3003, "The Big Bang Theory", "", 2007, new String[] {"Kaley Cuocu", "Jim Parsons"}, new String[] {"Chuck Lorre", "Bill Prady"}, MovieGenre.TV_SHOWS, 8.7);
	...
	private static void loadUsers() {
		users[0] = UserManager.getInstance().createUser(1000, "user0@prorigo.com","test", "Krishna", "M", Gender.MALE, UserType.USER);
		users[1] = UserManager.getInstance().createUser(1001, "user1@prorigo.com","test", "Shiva", "M", Gender.MALE, UserType.USER);
		users[2] = UserManager.getInstance().createUser(1002, "user2@prorigo.com","test", "Balaram", "M", Gender.MALE, UserType.EDITOR);
		users[3] = UserManager.getInstance().createUser(1003, "user3@prorigo.com","test", "Sunil", "M", Gender.MALE, UserType.EDITOR);
		users[4] = UserManager.getInstance().createUser(1004, "user4@prorigo.com","test", "Vaishnavi", "M", Gender.FEMALE, UserType.CHIEF_EDITOR);
	}
